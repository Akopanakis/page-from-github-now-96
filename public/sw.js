// KostoPro Enhanced Service Worker
const CACHE_NAME = "kostopro-enhanced-v1";
const urlsToCache = [
  "/",
  "/builder-kostopro-enhanced.json",
  ...
  "https://cdn.jsdelivr.net/npm/intro.js@7.2.0/introjs.min.css",
