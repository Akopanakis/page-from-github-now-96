...
const AuditTrailEnhanced: React.FC = () => {
  ...
  const getTimelineIconColor = (severity: string) => {
    switch (severity) {
      case "Critical":
        return "#dc2626";
      case "Error":
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            ...
            {language === "el" ? "Ιχνηλάτης Ελέγχου" : "Audit Trail"}
          </CardTitle>
              ...
              {filteredLogs.length > 15 && (
                <div className="text-center py-4">
                  <p className="text-sm text-gray-500 mb-2">
                    {language === "el"
                      ? `Εμφάνιση 15 από ${filteredLogs.length} γεγονότα στο χρονοδιάγραμμα`
                      : `Showing 15 of ${filteredLogs.length} events in timeline`}
                  </p>
                  <Button
                    variant="outline"
                    size="sm"
