...
const CostTheorySection: React.FC<CostTheorySectionProps> = ({
  ...
  const generateShortRunData = () => {
    ...
    for (let quantity = 10; quantity <= capacity; quantity += 10) {
      ...
      const marginalCost =
        variableRate * (1 + utilizationRate * utilizationRate * 0.5);
  ...
  const generateLongRunData = () => {
    ...
    for (let scale = 50; scale <= 500; scale += 25) {
      ...
      data.push({
        ...
        phase,
        efficiency:
          scale <= 150 ? "Αυξανόμενη" : scale <= 300 ? "Σταθερή" : "Φθίνουσα",
      });
    }
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg">
                      Παράμετροι Βραχυχρόνιου Κόστους
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <Label>
                        Σταθερά Κόστη: {formatCurrency(parameters.fixedCost)}
                        /μήνα
                      </Label>
                      <Slider
                    ...
                    <div>
                      <Label>
                        Μεταβλητό Κόστος: €{parameters.variableRate}/kg
                      </Label>
                      <Slider
                    ...
                    <div>
                      <Label>
                        Παραγωγική Ικανότητα: {parameters.capacity} τόνοι/μήνα
                      </Label>
                      <Slider
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <Alert>
                        ...
                        <AlertDescription>
                          <strong>Σημείο Κλεισίματος:</strong> Η παραγωγή
                          γίνεται ασύμφορη όταν το οριακό κόστος υπερβαίνει
                          σημαντικά την τιμή πώλησης. Για τρέχουσες τιμές
                          ~€8/kg, το σημείο κλεισίματος είναι στα{" "}
                          {Math.round(
                            parameters.fixedCost /
                              (8 - parameters.variableRate),
                          )}{" "}
                          kg/μήνα.
                        </AlertDescription>
                      </Alert>
                  ...
                  <ResponsiveContainer width="100%" height={400}>
                    <ComposedChart data={shortRunData}>
                      ...
                      <Line
                        yAxisId="rate"
                        type="monotone"
                        dataKey="averageVariable"
                        stroke="#f59e0b"
                        strokeWidth={2}
                        name="Μέσο Μεταβλητό (AVC)"
                      />
                      <Line
                        yAxisId="rate"
                        type="monotone"
                        dataKey="averageFixed"
                        stroke="#8b5cf6"
                        strokeWidth={2}
                        name="Μέσο Σταθερό (AFC)"
                      />
                    </ComposedChart>
                  </ResponsiveContainer>
                </CardContent>
            ...
            <TabsContent value="long-run" className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>
                    Μακροχρόνιες Καμπύλες Κόστους & Οικονομίες Κλίμακας
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="space-y-4">
                      ...
                      <Alert>
                        ...
                        <AlertDescription>
                          <strong>Βέλτιστο Μέγεθος:</strong> Το ελάχιστο
                          μακροχρόνιο κόστος επιτυγχάνεται στα 200-250 τόνους
                          μηνιαίας παραγωγής, με μέσο κόστος €7.00/kg.
                        </AlertDescription>
                      </Alert>
                    </div>
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg">
                      <h4 className="font-semibold mb-2">
                        Παράγοντες Οικονομιών Κλίμακας
                      </h4>
                      <ul className="text-sm space-y-1">
                        <li>
                          • <strong>Τεχνικές:</strong> Εξειδίκευση εργασίας,
                          καλύτερος εξοπλισμός
                        </li>
                        <li>
                          • <strong>Διοικητικές:</strong> Κατανομή γενικών
                          εξόδων
                        </li>
                        <li>
                          • <strong>Αγοραστικές:</strong> Μαζικές αγορές πρώτων
                          υλών
                        </li>
                        <li>
                          • <strong>Χρηματοδοτικές:</strong> Καλύτεροι όροι
                          δανεισμού
                        </li>
                        <li>
                          • <strong>Marketing:</strong> Κατανομή κόστους
                          προώθησης
                        </li>
                      </ul>
                    </div>
                  ...
                  <ResponsiveContainer width="100%" height={350}>
                    <LineChart data={longRunData}>
                      ...
                      <XAxis
                        dataKey="scale"
                        label={{
                          value: "Κλίμακα Παραγωγής (τόνοι/μήνα)",
                          position: "insideBottom",
                          offset: -5,
                        }}
                      />
                      ...
                      <Line
                        ...
                        stroke="#2563eb"
                        strokeWidth={4}
                        name="Μακροχρόνιο Μέσο Κόστος (LAC)"
                      />
                    </LineChart>
                  </ResponsiveContainer>
                </CardContent>
            ...
            <TabsContent value="breakdown" className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>
                    Ανάλυση Κόστους ανά Κατηγορία - Βιομηχανία Θαλασσινών
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                        ...
                        {costBreakdown.map((category, index) => (
                          ...
                          >
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm">
                              <div>
                                Σταθερό: {formatCurrency(category.fixed)}
                              </div>
                              <div>
                                Μεταβλητό: {formatCurrency(category.variable)}
                              </div>
                              <div className="font-semibold">
                                Σύνολο: {formatCurrency(category.total)}
                              </div>
                              <div className="font-semibold">
                                €{category.totalPerUnit.toFixed(2)}/kg
                              </div>
                            </div>
                          </div>
                        ))}
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        <strong>Στρατηγική Κόστους:</strong> Η πρώτη ύλη
                        αντιπροσωπεύει το 65% του συνολικού κόστους. Η
                        διαπραγμάτευση καλύτερων τιμών αγοράς και η
                        βελτιστοποίηση των απωλειών είναι κρίσιμες για την
                        κερδοφορία.
                      </AlertDescription>
                    </Alert>
                  </div>
                ...
                <CardContent>
                  <div className="space-y-4 mb-6">
                    <Alert>
                      ...
                      <AlertDescription>
                        <strong>Περιβάλλουσα Καμπύλη:</strong> Δείχνει το
                        ελάχιστο δυνατό κόστος για κάθε επίπεδο παραγωγής,
                        επιλέγοντας το βέλτιστο μέγεθος εγκατάστασης. Αποτελεί
                        τη μακροχρόνια καμπύλη μέσου κόστους.
                      </AlertDescription>
                    </Alert>
                  ...
                  <ResponsiveContainer width="100%" height={400}>
                    <LineChart data={envelopeData}>
                      ...
                      <Line
                        ...
                        strokeWidth={1}
                        strokeDasharray="5 5"
                        name="Εγκατάσταση 600 τόνων"
                      />
                      <Line
                        type="monotone"
                        dataKey="envelopeCost"
                        stroke="#dc2626"
                        strokeWidth={4}
                        name="Περιβάλλουσα Καμπύλη (LAC)"
                      />
                    </LineChart>
                  </ResponsiveContainer>
                </CardContent>
            ...
            <TabsContent value="optimization" className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>
                    Βελτιστοποίηση Κόστους & Στρατηγικές Αποτελεσματικότητας
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="bg-green-50 p-4 rounded-lg">
                        ...
                        <ul className="text-sm space-y-1">
                          <li>
                            • <strong>Βελτιστοποίηση χρησιμοποίησης:</strong>{" "}
                            Στόχος 85-90% ικαν��τητας
                          </li>
                          <li>
                            • <strong>Μείωση απωλειών:</strong> Βελτίωση
                            συντήρησης ψυκτικών
                          </li>
                          <li>
                            • <strong>Ευέλικτα ωράρια:</strong> Προσαρμογή σε
                            εποχικότητα
                          </li>
                          <li>
                            • <strong>Just-in-time:</strong> Μείωση κόστους
                            αποθήκευσης
                          </li>
                          <li>
                            • <strong>Ενεργειακή αποδοτικότητα:</strong> LED,
                            μονωτικά
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg">
                        ...
                        <ul className="text-sm space-y-1">
                          <li>
                            • <strong>Κάθετη ολοκλήρωση:</strong> Αγορά δικών
                            μονάδων
                          </li>
                          <li>
                            • <strong>Τεχνολογική αναβάθμιση:</strong>{" "}
                            Αυτοματοποίηση
                          </li>
                          <li>
                            • <strong>Γεωγραφική επέκταση:</strong> Νέες αγορές
                          </li>
                          <li>
                            • <strong>Διαφοροποίηση προϊόντων:</strong> Premium
                            σειρές
                          </li>
                          <li>
                            • <strong>Στρατηγικές συμμαχίες:</strong>{" "}
                            Συνεργασίες
                          </li>
                        </ul>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-purple-50 p-4 rounded-lg">
                        <h4 className="font-semibold text-purple-800 mb-2">
                          Δυναμικές Τιμολόγησης
                        </h4>
                        <div className="text-sm space-y-2">
                          <div>
                            • <strong>Peak Season:</strong> +15-25%
                            (Δεκέμβριος-Ιανουάριος)
                          </div>
                          <div>
                            • <strong>Low Season:</strong> -10-15%
                            (Μάιος-Αύγουστος)
                          </div>
                          <div>
                            • <strong>Weekend Premium:</strong> +5-10%
                            (Παρασκευή-Κυριακή)
                          </div>
                          <div>
                            • <strong>Bulk Discounts:</strong> -5-12% (&gt;2
                            τόνοι)
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="mt-6 bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-lg">
                    <h4 className="font-bold text-lg mb-3">
                      Σύνοψη Συστάσεων Βελτιστοποίησης
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      <div>
                        <div className="font-semibold text-blue-700">
                          Άμεσες Ενέργειες (0-6 μήνες)
                        </div>
